...
require "lib/AST/BinaryExpression"
  ...
  # Class: GreatherEqualExpression
  # Extends: BinaryExpression
  #
  # Class implementing Greater-Equal expression
  class GreatherEqualExpression < BinaryExpression
    ...
    def execute(var_AST)
      ...
      var_AST.greatherEqualExpressionExec(self)
